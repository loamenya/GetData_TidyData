...
For the output of the run_analysis.R file for the data For the provided in the 
UCI HAR Dataset. See the [README](README.md) for additional details.

Source data is from https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip.

### Tidy Mean

A data.table named `tidy_mean` is built with the following columns, and exported to the file tidy_mean.
